...
<body>
  ...
  <div class="py-5" style="">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <center><font size="5"><b>Contact from User</b></font></center>
        </div>
      </div>
	  <br></br>
      <div class="row">
		  ...
		  <?php
            ...
            if($result=$mysqli->query($q)){
				...
				<tr>
					...
					<?php $_SESSION['Question_ID']=$row['Question_ID'] ?>
			  		<?php if(is_null($row['Answer'])){?>
					 <td><a class="btn btn-danger" href="reply.php?id=<?php echo $row['Question_ID']?>">REPLY</a></td>
			  		<?php }else{?>
			  		<td><a class="btn btn-primary" href="reply2.php?id=<?php echo $row['Question_ID']?>">DONE</a></td>
			  		<?php }?>
					 <?php echo "</li>";
					 ?>
				<tr>
