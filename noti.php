    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <ul class="list-group">
     <?php
            $q="SELECT * FROM question WHERE User_ID ='".$_SESSION['User_ID']."';  ";
			...
			while($row=$result->fetch_array()){
				?>
                <tr>
                    <li class="list-group-item d-flex justify-content-between align-items-center" >Question:&nbsp;<?=$row['Question']?>
					<a class="btn btn-warning text-white" href="more.php?id=<?php echo $row['Question_ID']?>">More</a> </li>
