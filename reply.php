    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
				...
				?>
          <p class="lead">Question:&nbsp;<?php echo $row['Question'] ?></p>
          <p class="lead">Reply to user</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-12">
             ...
             <div class="form-group"> <textarea class="form-control" name="ans" id="form30" rows="8" placeholder="Answer"></textarea>
			 </div> <button type="submit" class="btn btn-warning text-white">SUBMIT</button>
