...
<!start code here>
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <center><font size="5"><b>User Status</b></font></center>
        </div>
      </div>
	  <br></br>
      <div class="row">
          ...
          <table class="table">
            ...
            <tbody>
			  <?php
                ...
                <tr>
                    <td>&nbsp <?=$row['User_ID']?> &nbsp </td> 
                    <td>&nbsp <?=$row['Title']?> &nbsp </td> 
                    <td>&nbsp <?=$row['First_Name']?> &nbsp </td> 
                    <td>&nbsp <?=$row['Last_Name']?> &nbsp </td> 
					<td>&nbsp <?=$row['National_ID']?> &nbsp </td>
					<td>&nbsp <?=$row['Birth_Date']?> &nbsp </td>
                    <td>&nbsp <?=$row['Email']?> &nbsp </td>
					<td>
						<?php echo "<td><a href='user_sd.php?uid="
