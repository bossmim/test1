...
<!--- Form --->
 <form action="booking_ne.php" method="post" id="form2">
  <center>
    <br>
    <br>
    <div class="container">
        ...
        <div class="col-md-12">
          <div class="btn-group">
            <select name="drop1" class="btn dropdown-toggle btn-light" data-toggle="dropdown" aria-expanded="false">
				<?php
					$s1 = array("Departure Station","Bangkok","Ubon Ratchathani","Khon Kaen");
					foreach ($s1 as $value) {
            ...
            <div class="btn-group">
              <select name="drop2" class="btn dropdown-toggle btn-light" data-toggle="dropdown" aria-expanded="false">
				<?php
					$s2 = array("Destination Station","Bangkok","Ubon Ratchathani","Khon Kaen");
					foreach ($s1 as $value) {
