...
<body>
  ...
  <div class="py-1">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <p contenteditable="false" name="fname">&nbsp; Name: &nbsp;<?php echo $urow['First_Name'];?></p>
		  <p  contenteditable="false" name="lname">&nbsp; Surname: &nbsp;<?php echo $urow['Last_Name'];?></p>
          <p  contenteditable="false" name="email">&nbsp; Email:  &nbsp;<?php echo $urow['Email'];?></p>
		  <p  contenteditable="false" name="naid">&nbsp; National ID:  &nbsp;<?php echo $urow['National_ID'];?></p>
		  <p  contenteditable="false" name="DOB">&nbsp; Birthday:  &nbsp;<?php echo $urow['Birth_Date'];?></p>
		  <p  contenteditable="false" name="tel">&nbsp; Tel:  &nbsp;<?php echo $urow['Tel'];?></p>
		  <p  contenteditable="false" name="address">&nbsp; Address:  &nbsp;<?php echo $urow['Address'];?></p>
        </div>
      </div>
        <center><a class="btn m-3 btn-warning text-white" href="edit_admin_p.php">Edit</a></center>
    </div>
  </div>
